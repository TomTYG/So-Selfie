...
- (id)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        soFunnyLabel.font =  [UIFont fontWithName:@"Tondu-Beta" size:textsize];
        ...
        self.soFunnyVotesLabel.font =  [UIFont fontWithName:@"Tondu-Beta" size:textsize];
        ...
        self.soFunnyRankLabel.font = [UIFont fontWithName:@"Tondu-Beta" size:textsize];
        ...
        soHotLabel.font =  [UIFont fontWithName:@"Tondu-Beta" size:textsize];
        ...
        self.soHotVotesLabel.font =  [UIFont fontWithName:@"Tondu-Beta" size:textsize];
        ...
        self.soHotRankLabel.font = [UIFont fontWithName:@"Tondu-Beta" size:textsize];
        ...
        soLameLabel.font =  [UIFont fontWithName:@"Tondu-Beta" size:textsize];
        ...
        self.soLameVotesLabel.font =  [UIFont fontWithName:@"Tondu-Beta" size:textsize];
        ...
        self.soLameRankLabel.font = [UIFont fontWithName:@"Tondu-Beta" size:textsize];
        ...
        tryAgainLabel.font =  [UIFont fontWithName:@"Tondu-Beta" size:textsize];
        ...
        self.tryAgainVotesLabel.font =  [UIFont fontWithName:@"Tondu-Beta" size:textsize];
        ...
        self.tryAgainRankLabel.font = [UIFont fontWithName:@"Tondu-Beta" size:textsize];
        ...
        self.eraseSelfieButton.titleLabel.font =  [UIFont fontWithName:@"Tondu-Beta" size:15];
