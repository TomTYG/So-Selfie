...
-(void)voteCollectionViewCellDoneVoting:(VoteCollectionViewCell *)cell {
    ...
    //[self.mainVoteCollectionView reloadItemsAtIndexPaths:[NSArray arrayWithObject:[NSIndexPath indexPathForItem:1 inSection:0]]];
    ...
    /*
    [self.mainVoteCollectionView performBatchUpdates:^() {
        [self.mainVoteCollectionView deleteItemsAtIndexPaths:[NSArray arrayWithObject:[NSIndexPath indexPathForItem:0 inSection:0]]];
        [self.mainVoteCollectionView insertItemsAtIndexPaths:[NSArray arrayWithObject:[NSIndexPath indexPathForItem:0 inSection:0]]];
    } completion:^(BOOL finished){
